     ...
     <div class="modal-dialog">
        <div class="modal-content">
             <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><center>Cancel Event</center></h4>
             </div>
            <div class="alert alert-danger">
            		Are you Sure want to cancel <big><?php echo $row['eventTitle']; ?></big>
            </div>
            <div class="modal-footer">
                <a class="btn btn-danger" href="delete_event.php<?php echo '?id='.$id; ?>"><i class="icon-check"></i>&nbsp;Yes</a>

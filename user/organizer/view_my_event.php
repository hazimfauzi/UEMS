    ...
    <div class="container-fluid">
      ...
      <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <?php include('delete_event_modal.php'); ?>
          ...
          <td><center>
              <button title="click for more details" id="<?php echo $id; ?>"  data-toggle="modal" data-target="#event_detail_modal<?php echo $id; ?>"><?php echo '<img width="300" height="100" src="' . $src . '">' ?><p>Click For More Details</p></button>
            </center>

                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                    	<div class="panel panel-default">
                        	...
                        	<div class="panel-body">
                            	<strong>Date :</strong> <p><?php echo $row['startDate']; ?><strong> until </strong><?php echo $row['endDate']; ?></strong><br/>
                                <strong>from</strong> <?php echo $row['startTime']; ?> <strong>to</strong> <?php echo $row['endTime']; ?></p>
                            	<strong>Location :</strong>
								<p><?php echo $row['eventLocation']; ?>,<br/>

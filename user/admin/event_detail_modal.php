        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body"> 
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#home<?php echo $row['eventId']; ?>" data-toggle="tab">Description</a> </li>
              <li><a href="#profile<?php echo $row['eventId']; ?>" data-toggle="tab">Event Date</a> </li>
              <li><a href="#messages<?php echo $row['eventId']; ?>" data-toggle="tab">Organized By</a> </li>
              <li><a href="#settings<?php echo $row['eventId']; ?>" data-toggle="tab">Approved By</a> </li>
            </ul>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="profile<?php echo $row['eventId']; ?>">
                <h4>Time</h4>
                <strong><?php echo date('h:i A ', strtotime($row['startTime'])); ?></strong> to <strong><?php echo date('h:i A ', strtotime($row['endTime'])); ?></strong>
                <h4>Date</h4>
                <strong><?php echo date('d/m/Y',strtotime($row['startDate'])); ?></strong> until <strong><?php echo date('d/m/Y',strtotime($row['endDate'])); ?></strong> </div>

							...
							<div class="panel-body">
								<form  method="POST" action="save_admin.php" enctype="multipart/form-data">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="inputEmail" name="matric_no"  placeholder="Staf Number" required>
									</div>
									<div class="form-group">
										<label >Name</label>
										<input class="form-control" type="text" id="inputPassword" name="name"  placeholder="What your name?" required>
									</div>
									<div class="form-group">
										<label >IC number</label>
										<input class="form-control" type="text" id="inputPassword" name="ic_number"  placeholder="I know you're not illegal immigrants" required>
									</div>
									<div class="form-group">

...
<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-plus fa-fw"></i>Add Organizer</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                	...
                	<div class="col-lg-8">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<form  method="POST" action="save_organizer.php" enctype="multipart/form-data">
									<div class="form-group">
										<label >Organizer Id (IC No.)</label>
										<input class="form-control" type="text" id="inputEmail" name="matric_no"  placeholder="IC Number" required>
									</div>
									<div class="form-group">
										<label >Name</label>
